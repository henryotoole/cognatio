"""
Setup / configuration for cognatio logging.
...
That is, logging to STDOUT and letting it handle the rest. This feels foreign and wrong to me, but I'm going
to give it a shot. By default this will wind up in systemd's journaling system and can be accessed with
the usual journalctl -f -u cognatio (or whatever the service file is named by the sysadmin)
