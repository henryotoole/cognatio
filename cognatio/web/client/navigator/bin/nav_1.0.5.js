...
var RegEditor = class extends Region {
  ...
  _on_link_post() {
    ...
    this.btn_spellcheck.addEventListener("click", () => {
      this.spellcheck_toggle();
    });
...
// cognatio/web/client/navigator/src/regs/reg_page_friends.js
var RegPageFriends = class extends Region {
  static {
    __name(this, "RegPageFriends");
  }
  fab_get() {
    let css = (
      /* css */
   ...
   */
  async load_friends() {
    return this.swyd.dh_friend.track_all_for_page(this.swyd.settings.page_id).then(() => {
  ...
  search(search_string) {
    ...
    this.render();
    this.swyd.dh_user.list(void 0, { "search": search_string }).then((matching_ids) => {
  ...
  _render_list() {
    ...
    if (this.settings.loading) {
      ...
      user_ids.forEach((user_id) => {
        users.push(this.swyd.dh_user.comp_get(user_id));
      });
      users.forEach((data) => {
...
// cognatio/web/client/navigator/src/comps/comp_user.js
var CompUser = class extends Component {
  static {
    __name(this, "CompUser");
  }
...
// cognatio/web/client/navigator/src/dh/dh_friend.js
var DHFriend = class extends DHREST {
  static {
    __name(this, "DHFriend");
  }
  constructor() {
    super("/api/v1/friend");
  }
